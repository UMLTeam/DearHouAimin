...
1. 窗体内容显示风格1。  
文字、图片、表格、框架、超链接。  
![图片](https://uploader.shimo.im/f/R2OlkLjr2nITixmq!thumbnail)

2. 窗体内容显示风格2。  
文档下载，文档上传。
![图片](https://uploader.shimo.im/f/0v03s1ku10kyEymO!thumbnail)

3. 窗体内容显示风格3。  
视频播放，PPT播放。
![图片](https://uploader.shimo.im/f/E5W0MesTogEiQA4e!thumbnail)

4. 窗体内容显示风格4。  
交流互动。邮件联系，在线QQ互动，在线微信互动，自编界面的互动。
![图片](https://uploader.shimo.im/f/E2Hkf3QiVbUBBi56!thumbnail)
...
![图片](https://uploader.shimo.im/f/VIVFG41OBr8vRZLy!thumbnail)

选择其中的“2012年省级精品资源共享课《合同法学》”链接。
《合同法学》课程的首页http://219.222.189.2/
![图片](https://uploader.shimo.im/f/59NgREO3CH8vObY2!thumbnail)

《合同法学》课程的“基础资源”页面http://219.222.189.2/index.html
![图片](https://uploader.shimo.im/f/UBg8vdOoz5MAtMLl!thumbnail)

2、厦门大学数据库实验室网址https://dblab.xmu.edu.cn/
![图片](https://uploader.shimo.im/f/J0F3iE7K18QeV6XJ!thumbnail)

高校大数据课程公共服务平台网址http://dblab.xmu.edu.cn/post/bigdata-teaching-platform/
![图片](https://uploader.shimo.im/f/ypnskGtSXvUjqXhS!thumbnail)

大数据课程学生服务站网址http://dblab.xmu.edu.cn/post/4331/
![图片](https://uploader.shimo.im/f/GNH7XH4tec0fe6B2!thumbnail)

大数据课程教师交流群网址http://dblab.xmu.edu.cn/post/4782/
![图片](https://uploader.shimo.im/f/fMjIsXPkGgohjIvI!thumbnail)
...
RUP的软件开发生命周期模型如下。  
![图片](https://uploader.shimo.im/f/WCizfsScBLcJWe7b!thumbnail)

RUP把软件开发生命周期划分为多个Cycle。每个Cycle生成一个产品的新的版本。每个Cycle都依次由四个连续的阶段(phase)组成。
![图片](https://uploader.shimo.im/f/hfEWrMhJFe4EIfGa!thumbnail)
