            ...
            <div class="column_1">
                <section class="leftNav">
                    ...
                    <ul>
                        ...
                        <li class="current"><a
                                href="<c:url value="/class_list_Servlet?method=LoadStudentClassList&classListpageQuery=1"/>">班级名册</a>
                        </li>
                        <li>
                            <a href="<c:url value ='/HomeworkServlet?method=LoadHomework&HomeworkpageQuery=1'/>">作业案例</a>
                        </li>
                    </ul>
                </section>
            </div>
                ...
                <article class="mainContent">
                    ...
                    <section class="article">
                        <div class="itemDetail newItemContent">
                            <div class="bar6">
                                <form action="<c:url value='/class_list_Servlet?method=searchByName&addr=html'/>"
                                      method="post">
                                    <input type="text" name="searchName" id="" placeholder=" 班级名" style="width:250px"
                                           class="input-text">
                                ...
                                <table class="planTable disCenter">
                                    ...
                                    <c:forEach items="${classListpageQuery.items}" var="class_list">
                                        <tr>
                                            ...
                                            <td><h3><a
                                                    href="<c:url value='/class_list_Servlet?method=Download_Class_File&class_id=${class_list.class_id}'/>"
                                                    download="${class_list.class_file_name}">下载</a></h3></td>
                                ...
                                <div class="pages">
                                    <div style="margin: auto">
                                        <c:if test="${classListpageQuery.currentPage!=1}">
                                            <span><a
                                                    href="<c:url value='/class_list_Servlet?method=LoadStudentClassList&classListpageQuery=1'/>">首页</a></span>
                                            <span><a
                                                    href="<c:url value='/class_list_Servlet?method=LoadStudentClassList&classListpageQuery=${classListpageQuery.currentPage-1}'/>">上一页</a></span>
                                        </c:if>
                                        <c:if test="${classListpageQuery.currentPage!=classListpageQuery.totalPage}">
                                            <span><a
                                                    href="<c:url value='/class_list_Servlet?method=LoadStudentClassList&classListpageQuery=${classListpageQuery.currentPage+1}'/>">下一页</a></span>
                                            <span><a
                                                    href="<c:url value='/class_list_Servlet?method=LoadStudentClassList&classListpageQuery=${classListpageQuery.totalPage}'/>">尾页</a></span>
                                        </c:if>
                                    </div>
                                </div>
