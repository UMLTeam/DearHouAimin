...
public class dataDao {
	...
	private static String url="jdbc:mysql://niracler.com:3307/uml_open_course_db?useSSL=false&useUnicode=true&characterEncoding=UTF-8&autoReconnect=true";//数据库网址
