...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="data_del()" class="btn btn-danger radius"><i
            class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" onclick="teachingVideo_add('添加录像','teachingVideo-add.html')"
                                                          href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加录像</a></span> <span class="r">共有数据：<strong>2</strong> 条</span>
    </div>
    <div class="mt-20">
        <table id="teachingVideo-table" class="table table-border table-bordered table-bg table-hover table-sort">
            <thead>
            <tr class="text-c">
            ...
            <tr class="text-c">
                ...
                <td>200M</td>
                <td>侯爱民</td>
                <td class="text-l"><a href="https://view.officeapps.live.com/op/view.aspx?src=http://www.niracler.com/resource/《软件需求分析与设计》课程简介.pptx" target="_blank">《软件需求分析与设计》课程录像</a></td>
                <td class="text-c">UML Web</td>
                <td>2018-12-11 13:19:42</td>
                <td class="td-status"><span class="label label-success radius">已发布</span></td>
                <td class="td-manage">
                    <a style="text-decoration:none" onClick="teachingVideo_stop(this,'10001')" href="javascript:;" title="下架">
                        <i class="Hui-iconfont">&#xe6de;</i>
                    </a>
                    <a style="text-decoration:none" class="ml-5" onClick="teachingVideo_edit('图库编辑','teachingVideo-add.html','10001')" href="javascript:;" title="编辑">
                        <i class="Hui-iconfont">&#xe6df;</i>
                    </a>
                    <a style="text-decoration:none" class="ml-5" onClick="teachingVideo_del(this,'002')"href="javascript:;" title="删除">
                        <i class="Hui-iconfont">&#xe6e2;</i>
                    </a>
                </td>
            </tr>
            <tr class="text-c">
                ...
                <td class="f-14 td-manage"><a style="text-decoration:none" onClick="teachingVideo_shenhe(this,'002')" href="javascript:;" title="审核">审核</a> <a style="text-decoration:none" class="ml-5" onClick="teachingVideo_edit('资讯编辑','teachingVideo-add.html','10001')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="teachingVideo_del(this,'002')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
            </tr>
            </tbody>
        </table>
    </div>
...
<script type="text/javascript">
    ...
    /*录像-审核*/
    function teachingVideo_shenhe(obj, id) {
        layer.confirm('审核文章？', {
                btn: ['通过', '不通过'],
                shade: false
            },
            function () {
                $(obj).parents("tr").find(".td-manage").prepend(
                    '<a class="c-primary" onClick="teachingVideo_start(this,id)" href="javascript:;" title="申请上线">申请上线</a>');
            ...
            function () {
                $(obj).parents("tr").find(".td-manage").prepend(
                    '<a class="c-primary" onClick="teachingVideo_shenqing(this,id)" href="javascript:;" title="申请上线">申请上线</a>');
