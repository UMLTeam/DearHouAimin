...
<body>
	<article class="page-container">
		<form class="form form-horizontal" id="form-article-add"
			action="/educationReformDetail3Action?type=editItem" method="post">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					...
					<input type="text" name="title" class="input-text" value="${param.title}"
						placeholder="" id="articletitle" name="articletitle">
				</div>
			</div>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					...
					<input type="text" name="author" class="input-text" value="${param.author}"
						placeholder="" id="articletitle" name="articletitle">
				</div>
			</div>
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="publication" class="input-text" value="${param.publication}"
						placeholder="" id="articletitle" name="articletitle">
				</div>
			</div>
