...
<div class="page-container">
    <form action="/ResourceServlet.do" class="text-c" method="post">
        ...
        <input type="text" name="search" placeholder="资源名称" style="width:250px" class="input-text">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
        ...
        <a class="btn btn-primary radius" onclick="courseware_add('添加实验任务','/admin/experimentalTask/experimentalTask-add.jsp')"
           href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加实验任务</a></span> <span class="r">共有数据：<strong>${sessionScope.resourceList.size()}</strong> 条</span>
    </div>
    <div class="mt-20">
